...
def model(pars, hostname='dum', processor=1):
	...
	m = atsxml.get_root('../test7_hillslope-30mSuite_template_fromCheckpoint.xml')
	...
	atsxml.replace_by_path(m,['cycle driver','restart from checkpoint file'],'../checkpoint_files/checkpoint_' + fname + '.h5')
...
s.run(cpus=hosts, workdir_base='run_fromCheckpoint_1Nov18', reuse_dirs=True)
