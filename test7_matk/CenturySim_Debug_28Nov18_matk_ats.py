...
def model(pars, hostname='dum', processor=1):
	...
	atsxml.replace_by_path(m,['cycle driver','restart from checkpoint file'],'../checkpoint_files/' + runName + checkpointRunName + '_checkpoint_files/checkpoint_' + fname + '.h5')
