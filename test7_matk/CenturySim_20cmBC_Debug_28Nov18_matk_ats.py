...
runName = "CenturySim_20cmBC"
suffix = "_Debug_28Nov18"
checkpointRunName = runName + "_Debug_27Nov18"
...
def model(pars, hostname='dum', processor=1):
	...
	m = atsxml.get_root('../test7_' + branchName + '_template_' + runName + suffix + '.xml')
	...
	atsxml.replace_by_path(m,['cycle driver','restart from checkpoint file'],'../checkpoint_files/' + checkpointRunName + '_checkpoint_files/checkpoint_' + fname + '.h5')
