...
plt.scatter(min_bOM,q_med,color='r')
plt.hold(True)
plt.scatter(max_bOM,q_med,color='b')
plt.title('Decreasing flux with increasing OM thickness')
plt.ylabel('Median total yearly flux [mol]')
plt.xlabel('OM thickness [m]')
plt.legend('Min Thickness','Max Thickness')
plt.show() 
